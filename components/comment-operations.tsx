...
async function deletePost(commentId: string) {
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuItem>
            <Link
              href={`/admin-dashboard/comment/edit/${comment.id}`}
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={async (event) => {
                ...
                const deleted = await deletePost(comment.id)
